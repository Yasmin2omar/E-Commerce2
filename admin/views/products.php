					...
					<div class="container-fluid">
						<div class="card">
							...
							<div class="card-body table-responsive p-0">								
								<table  class="table table-hover text-nowrap admin-products-table">
									<thead>
										<tr>
											<th width="60">ID</th>
											<th width="80"></th>
									...
									<tbody>
										...
										<?php foreach($products as $product):?>
											<tr>
											<td><?=$product->getID()?></td>
											<td><img src="/project3-e-commerce-main/<?= $product->getImage() ?>" width="120" class="img-thumbnail"></td>
											<td><a href="#"><?=$product->getCategoryId()?></a></td>
											<td>$<?=$product->getName()?></td>
											<td><?=$product->getPrice()?></td>
											<td><?=$product->getDescription()?></td>
											<td><?=$product->getStock()?></td>
											<td>
												<a href="index.php?page=update_product_controller&id=<?=$product->getID()?>">
													<svg class="filament-link-icon w-4 h-4 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
														<path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"></path>
													</svg>
												</a>
												<form method="post" action="index.php?page=remove_product_controller&id=<?=$product->getID()?>">
