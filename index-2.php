                    ...
                    <div class="row">
                        <div class="col-xl-6 col-md-6">
                            <div class="slider_content">
                                ...
                                <a class="button" href="product-details.php">Buy now</a>
                            </div>
                        </div>
                        <div class="col-xl-6 col-md-6">
                            <div class="slider_content">
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-md-6">
                            <div class="slider_content">
                                ...
                                <a class="button" href="product-details.php">Shop now</a>
                            </div>
                        </div>                        
                        <div class="col-xl-6 col-md-6">
                            <div class="slider_content">
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-md-6">
                            <div class="slider_content">
                                ...
                                <p>exclusive offer <span> 20% off </span> this week</p>
                                <a class="button" href="product-details.php">shopping now</a>
                            </div>
                        </div>                      
                        <div class="col-xl-6 col-md-6">
                            <div class="slider_content">
